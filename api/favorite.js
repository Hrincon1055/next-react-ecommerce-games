...
// Funcion para verificar favoritos
...
// Funcion para agregar juego a favoritos
export async function addFavoriteApi(idUser, idGame, logout) {
  try {
    ...
    if (size(dataFound) > 0 || !dataFound) {
      return "Este juego ya esta en la lista de favoritos";
    } else {
...
// Funcion para quitar juego a favoritos
...
// Funcion para obtener la lista de favoritos
